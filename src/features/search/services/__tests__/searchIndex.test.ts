...
describe("search index destination availability parity (KAI-93)", () => {
  it("indexes all 1011 recommendation-eligible canonical destination IDs identically across English and Japanese", async () => {
